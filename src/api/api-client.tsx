...
export function signUpUser(user: User): Promise<User> {
    ...
    return fetch('https://orchid-backend-webdev.onrender.com/users', {
        method: 'POST',
        headers: {
...
export function signInUser(username:string, password:string): Promise<string> {
    // API call to sign up a user
    return fetch('https://orchid-backend-webdev.onrender.com/auth/token', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
export function getUser(id: number): Promise<User> {
    ...
    return fetch(`https://orchid-backend-webdev.onrender.com/users/${id}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
        },
